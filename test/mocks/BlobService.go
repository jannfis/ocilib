...
func (_m *BlobService) Create(ctx context.Context, options ...distribution.BlobCreateOption) (distribution.BlobWriter, error) {
...
func (_m *BlobService) Get(ctx context.Context, dgst digest.Digest) ([]byte, error) {
...
func (_m *BlobService) Open(ctx context.Context, dgst digest.Digest) (io.ReadSeekCloser, error) {
	ret := _m.Called(ctx, dgst)
...
func (_m *BlobService) Put(ctx context.Context, mediaType string, p []byte) (distribution.Descriptor, error) {
...
func (_m *BlobService) Resume(ctx context.Context, id string) (distribution.BlobWriter, error) {
...
func (_m *BlobService) Stat(ctx context.Context, dgst digest.Digest) (distribution.Descriptor, error) {
	ret := _m.Called(ctx, dgst)
